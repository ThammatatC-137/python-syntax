...
def crop_econ(water, area, annual_yield, price):
    ...
    total_earning = total_yield * price
    ypw = total_yield / total_water if total_water != 0 else 0
    epw = total_earning / total_water if total_water != 0 else 0
    epa = total_earning / area if area != 0 else 0
